...
export function CategorySelectorDialog({
  ...
  const subcategories = pendingCategoryId
    ? pendingSubcategories.subcategories
  ...
  useEffect(() => {
    ...
    pendingCategoryId,
    pendingSubcategories.isLoading,
    pendingSubcategories.subcategories.length,
    onSelect,
    onOpenChange,
  ]);
  ...
  const categoryGroups = useMemo(() => {
    const categoryMap = new Map<
      string,
      {
        ...
        icons: string[];
        color: string;
        existingCategory?: IFinanceCategory;
      }
    >();
    ...
    categories.forEach((category) => {
      ...
      if (!categoryMap.has(category.name)) {
        categoryMap.set(category.name, {
          ...
          color:
            category.color ||
            getDefaultColorForCategory(category.name, categories),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[85vh]">
        <DialogHeader>
          ...
          <DialogDescription>Escolha uma categoria existente</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-3 max-h-[60vh] overflow-y-auto">
            ...
            {categoryGroups.length === 0 ? (
              ...
              categoryGroups.map((group) => {
                const isSelected =
                  group.existingCategory?.id === selectedCategoryId;
                    ...
                    <div className="p-4">
                      ...
                      {group.existingCategory ? (
                        <Button
                          ...
                          className="w-full"
                          onClick={() =>
                            handleSelect(group.existingCategory!.id)
                          }
                        >
        ...
        {pendingCategoryId && (
          <SubcategorySelector
            ...
            category={
              categories.find((cat) => cat.id === pendingCategoryId) || null
            }
