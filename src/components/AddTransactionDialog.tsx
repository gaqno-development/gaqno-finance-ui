...
import {
  handleMutationError,
  handleFormError,
} from "@gaqno-development/frontcore/utils/error-handler";
        ...
        <form onSubmit={handleSubmit(onSubmit, onError)} className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => {
                    setValue("type", checked ? "income" : "expense", {
                      shouldValidate: true,
                    });
                  }}
                />
          ...
          {isExpense && (
            <>
              ...
              <div className="grid grid-cols-12 gap-3">
                <div className="col-span-4 space-y-1.5">
                  <Label htmlFor="credit_card_id" className="text-xs">
                    Cartão de Crédito
                  </Label>
                  <Select
                ...
                <div className="col-span-4 space-y-1.5">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value={TransactionStatus.A_PAGAR}>
                        A pagar
                      </SelectItem>
                      <SelectItem value={TransactionStatus.PAGO}>
                        Pago
                      </SelectItem>
                      <SelectItem value={TransactionStatus.EM_ATRASO}>
                        Em atraso
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div className="col-span-2 space-y-1.5">
                  <Label htmlFor="installment_current" className="text-xs">
                    Parcela Atual
                  </Label>
                  <Input
          ...
          {watch("is_recurring") && (
            <div className="grid grid-cols-12 gap-3 p-3 border rounded-md bg-muted/20">
              <div className="col-span-4 space-y-1.5">
                <Label htmlFor="recurring_type" className="text-xs">
                  Tipo de recorrência
                </Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="fifth_business_day">
                      Quinto dia útil
                    </SelectItem>
              ...
              {watch("recurring_type") === "custom" && (
                <div className="col-span-3 space-y-1.5">
                  <Label htmlFor="recurring_day" className="text-xs">
                    Dia do mês
                  </Label>
                  <Input
                    id="recurring_day"
